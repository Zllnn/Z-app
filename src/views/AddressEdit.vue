<template>
  <div class="address-edit-box">
    ...
    <!--Vant 提供的地址编辑组件，参数详情见官方文档https://vant-contrib.gitee.io/vant/#/zh-CN/address-edit-->
    <van-address-edit class="edit" :area-list="state.areaList" :address-info="state.addressInfo"
